...
//   const title = "Algae Cooking Oil";

//   // Llamar tu función actual (devuelve solo la primera variante)
//   const chosenVariant = getVariantIdFromProduct(title);
//   Logger.log(`Variant ID elegido por la función: ${chosenVariant}`);

//   // Hacer la misma query para inspeccionar TODAS las variantes
//   const { SHOP_URL, ACCESS_TOKEN } = getConfig();
//   const query = {
//     query: `
//     {
...
//     Logger.log(`Todas las variantes para "${title}":`);
//     variants.forEach((v, i) => {
//       Logger.log(`  Variante ${i + 1}: ID=${v.node.id}, Título=${v.node.title}, SKU=${v.node.sku}`);
//     });
//   } catch (e) {
//     Logger.log(`Error al obtener todas las variantes para '${title}': ${e}`);
//   }
// }
